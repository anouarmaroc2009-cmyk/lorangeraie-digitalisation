-- Colle ce script dans Supabase SQL Editor (app.supabase.com → projet → SQL Editor)
-- et exécute-le pour créer toutes les tables.
-- Puis exécute-le aussi sur la base Aiven si elle ne les a pas encore.
...
CREATE TABLE "TeacherLevel" (
    ...
    CONSTRAINT "TeacherLevel_pkey" PRIMARY KEY ("teacherId","level")
);
...
CREATE TABLE "Student" (
    ...
    "reenrolled" BOOLEAN NOT NULL DEFAULT false,
    "monthlyTuition" DOUBLE PRECISION,
...
CREATE TABLE "TuitionTracking" (
    "id" TEXT NOT NULL,
    "studentId" TEXT NOT NULL,
    "academicYear" TEXT NOT NULL,
    "monthlyAmount" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "tuitionDue" DOUBLE PRECISION NOT NULL,
    "tuitionPaid" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "monthsPaid" INTEGER NOT NULL DEFAULT 0,
    "inscriptionFee" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "inscriptionPaid" BOOLEAN NOT NULL DEFAULT false,
    "paidFullYear" BOOLEAN NOT NULL DEFAULT false,
    "status" "PaymentStatus" NOT NULL DEFAULT 'UNPAID',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    CONSTRAINT "TuitionTracking_pkey" PRIMARY KEY ("id")
);
